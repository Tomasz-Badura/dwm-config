...
static const char *rebootcmd[]	= { "prompt", "-p", "Reboot?", "-c", "reboot", NULL };
static const char *shutdowncmd[]= { "prompt", "-p", "Shutdown?", "-c", "shutdown 0", NULL };
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        MODKEY,         Button1,        sigstatusbar,   {.i = 2} },
	{ ClkStatusText,        0,              Button3,        sigstatusbar,   {.i = 3} },
	{ ClkStatusText,        MODKEY,         Button3,        sigstatusbar,   {.i = 4} },
